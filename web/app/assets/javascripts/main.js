...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["RaceSessionCompetitionDialogComponent"] = __webpack_require__(2);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RaceSessionCompetitionStore = __webpack_require__(184);

	var PilotsActions = __webpack_require__(176);
	var RaceSessionActions = __webpack_require__(185);

	var RaceSessionCompetitionDialogEntryComponent = __webpack_require__(187);
	    ...
	    return (
	      React.createElement("div", null, 
	        ...
	        React.createElement("div", {className: "form-group"}, 
	          ...
	          React.createElement("input", {className: "form-control", type: "text", onChange: this._changeTitle, defaultValue: "Competition", value: this.state.title, required: true})
	        ), 
	        React.createElement("div", {className: "form-group"}, 
	          React.createElement("label", null, "Max laps:"), 
	          React.createElement("input", {className: "form-control", type: "text", onChange: this._changeMaxLaps, value: this.state.max_laps, required: true})
	        ), 
	        React.createElement("div", {className: "form-group"}, 
	          React.createElement("label", null, "Num Satellites:"), 
	          React.createElement("input", {className: "form-control", type: "text", onChange: this._changeNumSatellites, value: this.state.num_satellites, required: true})
	        ), 
	        React.createElement("div", {className: "form-group"}, 
	        ...
	        React.createElement("table", {className: "table table-striped"}, 
	          React.createElement("thead", null, 
	            React.createElement("tr", null, 
	              ...
	              React.createElement("th", null, "Transponder"), 
	              React.createElement("th", null, "Quad"), 
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _actionsPilot_actionJs = __webpack_require__(176);

	var _actionsPilot_actionJs2 = _interopRequireDefault(_actionsPilot_actionJs);

	var PilotsStore = (function () {
	  function PilotsStore() {
	    _classCallCheck(this, PilotsStore);

	    this.bindAction(_actionsPilot_actionJs2['default'].list, this.onList);

	    this.data = [];
	  }

	  _createClass(PilotsStore, [{
	    key: 'onList',
	    value: function onList(data) {
	...
	exports['default'] = _alt2['default'].createStore(PilotsStore, 'PilotsStore');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PilotAPI = __webpack_require__(177);
	var PilotsStore = __webpack_require__(160);

	var PilotActions = (function () {
	  function PilotActions() {
	    _classCallCheck(this, PilotActions);
	  }

	  _createClass(PilotActions, [{
	    key: 'list',
	    value: function list() {
	      var self = this;
	...
	exports['default'] = _alt2['default'].createActions(PilotActions);
	module.exports = exports['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	PilotApi.list = function (callback) {
	  ...
	  request.get("/api/v1/pilot").send().set('Content-Type', 'application/json').end(function (err, result) {
	    callback(err, result);
	  });
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RaceSessionAPI = __webpack_require__(186);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RaceSessionCompetitionDialogEntryComponent = React.createClass({displayName: "RaceSessionCompetitionDialogEntryComponent",
	  getInitialState: function(){
	  ...
	  render: function(){
	    ...
	    return (
	      React.createElement("tr", null, 
	        ...
	        React.createElement("td", null, 
	          React.createElement("input", {value: this.state.token, onChange: this.changePilotToken})
	        ), 
	        React.createElement("td", null, 
	          this.props.pQuad
	        ), 
	        React.createElement("td", null, 
	          React.createElement("button", {onClick: this.clickedRemove, className: "btn btn-warning"}, "Remove")
	        )
	      ));
	  }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["ReactDOM"] = __webpack_require__(189);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
